        ...
        <>
            <div id="contact" className="contact" style={{ position: "relative" }}>
                <div className="mainContact">
                    <h2>Contact</h2>
                    <a href="mailto:hello@andrewli.site" title="Email me">
                        <span className="contactIcons">
                            <IoMdMail size={iconSize} color="2EA2F8" />
                        </span>
                        hello@
                        <wbr />
                        andrewli.site
                    ...
                    >
                        <span className="contactIcons">
                            <AiFillLinkedin size={iconSize} color="2EA2F8" />
                        </span>
                        andrew-li23
                    </a>
                    <br />
                    <a href="https://github.com/Zeyu-Li" title="Check my GitHub" rel="noreferrer" target="_blank">
                        <span className="contactIcons">
                            <VscGithub size={iconSize} color="2EA2F8" />
                        </span>
                        Zeyu-Li
                    </a>
                </div>
