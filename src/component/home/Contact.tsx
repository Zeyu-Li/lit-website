    ...
    return (
        ...
        <div id="contact" className="contact" style={{position: "relative"}}>
            <div className="mainContact">
                ...
                <a href="https://www.linkedin.com/in/andrew-li23/" title="Connect with me on LinkedIn" rel="noreferrer" target="_blank"><span className="contactIcons"><AiFillLinkedin size={iconSize} color="2EA2F8" /></span>andrew-li23</a><br/>
                <a href="https://github.com/Zeyu-Li" title="Check my GitHub" rel="noreferrer" target="_blank"><span className="contactIcons"><VscGithub size={iconSize} color="2EA2F8" /></span>Zeyu-Li</a>
            </div>
